...
const I18N = {
  uz: {
    ...
    'sport.today': 'Bugungi o‘yinlar',
    'sport.evening': 'Bugun kechqurun',
    'sport.liveNow': 'Hozir jonli',
    'sport.otherToday': 'Bugungi boshqa o‘yinlar',
    'sport.otherDays': 'Boshqa kunlar',
    'sport.news': 'Futbol yangiliklari',
    'sport.live': 'JONLI',
    'sport.finished': 'Tugadi',
    'sport.upcoming': 'Boshlanadi',
    'sport.allLeagues': 'Barcha ligalar',
    'sport.noMatches': 'Bugun o‘yin yo‘q',
    'sport.noMatchesHint': 'Boshqa ligani tanlang yoki ertaga qayting.',
    'sport.loading': 'O‘yinlar yuklanmoqda...',
  ...
  ru: {
    ...
    'sport.today': 'Матчи сегодня',
    'sport.evening': 'Сегодня вечером',
    'sport.liveNow': 'Идут сейчас',
    'sport.otherToday': 'Другие матчи сегодня',
    'sport.otherDays': 'Другие дни',
    'sport.news': 'Новости футбола',
    'sport.live': 'LIVE',
    'sport.finished': 'Завершён',
    'sport.upcoming': 'Начало',
    'sport.allLeagues': 'Все лиги',
    'sport.noMatches': 'Сегодня матчей нет',
    'sport.noMatchesHint': 'Выберите другую лигу или зайдите завтра.',
    'sport.loading': 'Загружаем матчи...',
